...
- [BASTION-TAGGING-GUIDE.md](../../security/BASTION-TAGGING-GUIDE.md): Tag organization for username items
- [RISK-ANALYSIS.md](../../security/RISK-ANALYSIS.md): Risk scoring algorithm and analysis system
- [packages/bastion/src/bastion/username_generator.py](https://github.com/jakehertenstein/bastion/blob/main/packages/bastion/src/bastion/username_generator.py): Implementation details
