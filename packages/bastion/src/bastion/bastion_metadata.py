...
class BastionMetadata:
    ...
    # Password Management
    password_changed: str | None = None  # YYYY-MM-DD
    password_expires: str | None = None  # YYYY-MM-DD
    password_rotation_policy: str | None = None  # "90d", "180d", "365d", "manual"

    # Username Management
    username_changed: str | None = None  # YYYY-MM-DD
    username_type: str | None = None  # "generated", "manual"

    # 2FA/TOTP Management
    totp_seed_issued: str | None = None  # YYYY-MM-DD
    totp_seed_expires: str | None = None  # YYYY-MM-DD
    totp_seed_changed: str | None = None  # YYYY-MM-DD
    twofa_method_changed: str | None = None  # YYYY-MM-DD

    # Security Events
    last_security_review: str | None = None  # YYYY-MM-DD
    breach_detected: str | None = None  # YYYY-MM-DD
    breach_remediated: str | None = None  # YYYY-MM-DD

    # Account Lifecycle
    account_created: str | None = None  # YYYY-MM-DD
    last_activity: str | None = None  # YYYY-MM-DD

    # Recovery & Access
    recovery_email_changed: str | None = None  # YYYY-MM-DD
    recovery_phone_changed: str | None = None  # YYYY-MM-DD
    backup_codes_generated: str | None = None  # YYYY-MM-DD

    # Risk Scoring
    risk_level: str | None = None  # "CRITICAL", "HIGH", "MEDIUM", "LOW"
    risk_score: str | None = None  # Numeric score as string
    risk_last_calculated: str | None = None  # YYYY-MM-DD

    # Monitoring
    next_review_due: str | None = None  # YYYY-MM-DD
    next_rotation_due: str | None = None  # YYYY-MM-DD

    # Notes
    bastion_notes: str | None = None  # Free-form security notes
