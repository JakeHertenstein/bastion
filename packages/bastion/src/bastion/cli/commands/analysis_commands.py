...
from .analyze import analyze_dependencies, analyze_risk, query_accounts
from .audit import (
    audit_missing_email,
    audit_no_tags,
    audit_same_apps,
...
def register_commands(app: typer.Typer) -> None:
    ...
    def analyze_command(
        ...
        \bExamples:
          ...
          bastion analyze risk --account "Google"        # Show risk for a specific account title
          bastion analyze risk --account-uuid abc123      # Show risk for a specific account UUID
