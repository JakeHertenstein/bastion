...
def register_commands(app: typer.Typer) -> None:
    ...
    def generate_command(
        ...
        output: Annotated[Path | None, typer.Option("--output", help="[entropy] Output path for visualization")] = None,
        ...
        extend_bits: Annotated[int | None, typer.Option("--extend-bits", help="[entropy combine] Extend output using SHAKE256")] = None,
    ) -> None:
        """
        \bGenerate mermaid diagrams, deterministic usernames, or entropy pools.
        ...
        \bNotes:
            Larger samples yield more accurate ENT statistics. Default 16KB for EXCELLENT quality.
