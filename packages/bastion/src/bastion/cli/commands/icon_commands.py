...
def register_commands(app: typer.Typer) -> None:
    ...
    def icons_command(
        ...
        item: Annotated[str | None, typer.Option("--item", help="[attach] Item UUID to attach icon to")] = None,
        issuer: Annotated[str | None, typer.Option("--issuer", help="[attach] Issuer name for icon matching")] = None,
        icon_file: Annotated[str | None, typer.Option("--icon", help="[attach] Specific icon filename to use")] = None,
        output_dir: Annotated[str | None, typer.Option("--output", help="[export] Directory to export icons to")] = None,
        ...
        aegis_dir: Annotated[str | None, typer.Option("--aegis-dir", help="Path to aegis-icons directory")] = None,
    ) -> None:
        """
        \bManage aegis-icons for YubiKey OATH accounts.
