...
from .yubikey import link_yubikey_with_uuid, yubikey_link_all
...
def register_commands(app: typer.Typer) -> None:
    ...
    def link_command(
        ...
        """
        \bLink YubiKey serial to 1Password crypto wallet item UUID.

        \bDetails:
            Stores the correlation so OATH passwords can be auto-loaded from 1Password.
    ...
    def create_command(
        ...
        """
        \bCreate relationships between items or add new people.
    ...
    def verify_command(
        ...
        """
        \bVerify relationships for consistency.
