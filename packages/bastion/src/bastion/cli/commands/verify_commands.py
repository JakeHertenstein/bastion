...
def register_commands(app: typer.Typer) -> None:
    ...
    def verify_command(
        ...
        label: Annotated[str | None, typer.Option("--label", "-l", help="Full label (if not inferring from domain)")] = None,
        salt_uuid: Annotated[str | None, typer.Option("--salt-uuid", help="Specific salt UUID to use")] = None,
