// Auto-generated BIP-39 English wordlist (2048 words).
// Generated from the project's python environment for client-side validation.
export const BIP39_WORDLIST = [
  ...
  "area","arena","argue","arm","armed","armor","arms","army","around","arrange",
  ...
  "badge","bag","balance","balcony","ball","balm","banana","banner","bar","barely",
  ...
  "body","boil","bold","bolt","bomb","bone","bonus","book","boost","border",
  ...
  "increase","index","indicate","indoor","industry","infinite","inform","inhale","inherit","initial",
  ...
  "mixup","model","modify","mom","moment","monitor","monkey","monster","month","moon",
  ...
  "puzzle","pyramid","quality","quantum","quarter","question","quick","quiet","quit","quiz",
  ...
  "sock","sodium","soft","solar","soldier","solid","solution","solve","someone","song",
