...
def analyze_entropy(
    ...
    try:
        ...
        table.add_row("Pattern Entropy", f"{analysis['pattern_entropy_bits']} bits", f"Coordinate selection entropy")
...
def analyze_bases(
    ...
    try:
        ...
        console.print(f"• All modes generate 4-character tokens from 10×10 grid")
